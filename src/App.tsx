...
function App() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      {showLogoutModal && (
        <div style={{background: "rgba(0,0,0,0.3)"}} className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
        ...
        <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 shadow-sm">
          <div className="flex justify-around items-center h-16">
            ...
            <button
              ...
              className="flex flex-col items-center justify-center w-full h-full text-gray-500 hover:text-gray-700"
            >
